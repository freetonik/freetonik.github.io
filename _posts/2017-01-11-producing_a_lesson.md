...
Потом я перехожу к тексту на компьютере. Использую любимый редактор Sublime Text 3 (_нет, он не умер. нет, Атом не лучше_). Один урок — это примерно 1000 слов или 4500 знаков. На это уходит в лучшем случае час-полтора, в худшем — несколько часов.
